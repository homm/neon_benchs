...
opTriBoxBlur_premul_horz(
    struct image32* restrict Rimg,
    const struct image32* restrict Simg, uint32_t r)
{
    uint32_t d = r * 2 + 1;
    ...
    for (int y = 0; y < Simg->ysize - 1; y += 1) {
        ...
        pixel32* rdata = (pixel32*) (Rimg->data + Rimg->next_line * y);
        ...
        b[0].r = (uint32_t) (X1.r * 256 * rev_d);
        b[0].g = (uint32_t) (X1.g * 256 * rev_d);
        b[0].b = (uint32_t) (X1.b * 256 * rev_d);
        b[0].a = (uint32_t) (X1.a * 256 * rev_d);
        X2.r = b[0].r * (r + 1);
        X2.g = b[0].g * (r + 1);
        X2.b = b[0].b * (r + 1);
        X2.a = b[0].a * (r + 1);
        for (int x = 1; x <= r; x += 1) {
            ...
            b[x].r = (uint32_t) (X1.r * 256 * rev_d);
            b[x].g = (uint32_t) (X1.g * 256 * rev_d);
            b[x].b = (uint32_t) (X1.b * 256 * rev_d);
            b[x].a = (uint32_t) (X1.a * 256 * rev_d);
            X2.r += b[x].r;
            X2.g += b[x].g;
            X2.b += b[x].b;
            X2.a += b[x].a;
        ...
        for (int x = 1; x <= r; x += 1) {
            ...
            b[x + r].r = (uint32_t) (X1.r * 256 * rev_d);
            b[x + r].g = (uint32_t) (X1.g * 256 * rev_d);
            b[x + r].b = (uint32_t) (X1.b * 256 * rev_d);
            b[x + r].a = (uint32_t) (X1.a * 256 * rev_d);
            X2.r += b[x + r].r - b[0].r;
            X2.g += b[x + r].g - b[0].g;
            X2.b += b[x + r].b - b[0].b;
            X2.a += b[x + r].a - b[0].a;
        ...
        rdata[0].r = (uint8_t) (X3.r * rev_d256);
        rdata[0].g = (uint8_t) (X3.g * rev_d256);
        rdata[0].b = (uint8_t) (X3.b * rev_d256);
        rdata[0].a = 255;

        for (int x = 1; x < Simg->xsize; x += 1) {
            ...
            last_b.r = b[(x + r2) & r_mask].r = (uint32_t) (X1.r * 256 * rev_d);
            last_b.g = b[(x + r2) & r_mask].g = (uint32_t) (X1.g * 256 * rev_d);
            last_b.b = b[(x + r2) & r_mask].b = (uint32_t) (X1.b * 256 * rev_d);
            last_b.a = b[(x + r2) & r_mask].a = (uint32_t) (X1.a * 256 * rev_d);
            ...
            rdata[x].r = (uint8_t) (X3.r * rev_d256);
            rdata[x].g = (uint8_t) (X3.g * rev_d256);
            rdata[x].b = (uint8_t) (X3.b * rev_d256);
            rdata[x].a = 255;
        }
    }
}
