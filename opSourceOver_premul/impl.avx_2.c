                    ...
                    const uint8_t* restrict Drgba, size_t len)
{
    ...
    for (; i < len*4 - 28; i += 32) {
        ...
        __m256i Rx2lo = _mm256_maddubs_epi16(
            _mm256_unpacklo_epi8(_mm256_set1_epi8((char) 255), Sax4),
            _mm256_unpacklo_epi8(Sx4, Dx4));
        __m256i Rx2hi = _mm256_maddubs_epi16(
            _mm256_unpackhi_epi8(_mm256_set1_epi8((char) 255), Sax4),
            _mm256_unpackhi_epi8(Sx4, Dx4));
